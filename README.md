...
├── templates/
│   └── index.html       # Frontend SPA (landing + form + results)
└── static/
    ├── css/
...
|--------|----------|-------------|
| `GET` | `/` | Landing page |
| `POST` | `/api/complaints` | Submit a complaint for AI analysis |
